...
<form method="POST" action="../controlador/configurarPartida.php">
     ...
     <input type="radio" name="tablero" id="100" value="100" checked> 10 x 10 (pequeño) </input>
     ...
     <input type="radio" name="acorazados" id="1" value="1"> 1 </input>
     ...
     <input type="radio" name="posicion_acorazados" id="vertical" value="vertical"> vertical </input>
...
<div class="div-form">
 ...
 <input type="radio" name="color_acorazados" id="azul" value="blue"> azul </input>
     ...
     <input type="radio" name="destructores" id="3" value="3" checked> 3 </input>
     ...
     <input type="radio" name="posicion_destructores" id="vertical" value="vertical"> vertical </input>
 ...
 <input type="radio" name="color_destructores" id="azul" value="blue"> azul </input>
     ...
     <input type="radio" name="submarinos" id="3" value="3"> 3 </input>
     ...
     <input type="radio" name="posicion_submarinos" id="vertical" value="vertical"> vertical </input>
 ...
 <input type="radio" name="color_submarinos" id="azul" value="blue"> azul </input>
     ...
     <input type="radio" name="posicion_portaviones" id="vertical" value="vertical"> vertical </input>
